...
public class OEFetcher {
	...
	public static ArrayList<ObservationEvent> getOES(String url) throws JSONException, IOException{
		...
		return extractArrayListFromJSON(is);
	}

	private static ArrayList<ObservationEvent> extractArrayListFromJSON(
			InputStream is) throws IOException, JSONException {
	...
	public static ArrayList<ObservationEvent> getSearchResult(String url,
			HashMap<String, String> map) throws ClientProtocolException, IOException, JSONException {
		List<NameValuePair> list = new ArrayList<NameValuePair>();
		list.add(new BasicNameValuePair("tag_selected",map.get("tag_selected")));
		list.add(new BasicNameValuePair("name_selected",map.get("name_selected")));
		list.add(new BasicNameValuePair("desc_selected",map.get("desc_selected")));
		list.add(new BasicNameValuePair("pattern",map.get("pattern")));
		InputStream is = connectToWithList(url,list);
		return extractArrayListFromJSON(is);
	}
}
