...
/**
 * Activity that enables audio capture and messaging it back to server.
 * @author Oguz Demir
 * @author Ozan Ýrsoy
 *
 */
public class AudioActivity extends Activity {
	...
	/** Called when the start / stop button is pushed. 
	 * 
	 * @param start Boolean value indicating start/stop type.
	 * 
	 * */
	...
	/**
	 * Prepares media recorder,sets audio source as mic, sets output format as 3GP and sets output file.
	 * After preparation is finished, starts recording.
	 */
	...
	/**
	 * Stops and releases media recorder.
	 */
	...
	/**
	 * Connects to server and sends the audio file data to server.
