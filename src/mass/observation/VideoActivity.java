...
/**
 * 
 * Enables video recording and sends video message back to server.
 * 
 * @author Oðuz Demir
 * @author Ozan Ýrsoy
 *
...
public class VideoActivity extends Activity {
	...
	/**
	 * Calls when activity is started.
	 */
	@Override
	...
	/**
	 * Enables background processing of data communcation task.
	 * 
	 * @author Oðuz Demir
	 * @author Ozan Ýrsoy
	 *
	 ...
	 * @return The uri of newly created media file.
	 */
	private static Uri getOutputMediaFileUri(int type){
	      return Uri.fromFile(getOutputMediaFile(type));
	}
	/**
	 * Sends video file to server.
	...
	/**
	 * 
	 * Connects to server with video file.
	 * 
	...
	/**
	 * Creates an output media file for storing video data.
	 * @param type Type of the media file.
	 * @return Output media file.
	 */
